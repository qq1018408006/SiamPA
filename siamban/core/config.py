...
__C.TRAIN.REFINE_WEIGHT_SCORE = 1.0

__C.TRAIN.REFINE_WEIGHT_BOX = 1.0
...
__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/home/xiao/Dataset/vid/crop511'
__C.DATASET.VID.ANNO = '/home/xiao/Dataset/vid/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = '/home/xiao/Dataset/ybb/crop511'
__C.DATASET.YOUTUBEBB.ANNO = '/home/xiao/Dataset/ybb/train.json'
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = 200000

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/home/xiao/Dataset/coco/crop511'
__C.DATASET.COCO.ANNO = '/home/xiao/Dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = 100000

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/home/xiao/Dataset/det/crop511'
__C.DATASET.DET.ANNO = '/home/xiao/Dataset/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = 200000

__C.DATASET.GOT10K = CN()
__C.DATASET.GOT10K.ROOT = '/home/xiao/Dataset/got10k/crop511'
__C.DATASET.GOT10K.ANNO = '/home/xiao/Dataset/got10k/train.json'
__C.DATASET.GOT10K.FRAME_RANGE = 100
__C.DATASET.GOT10K.NUM_USE = 200000

__C.DATASET.LASOT = CN()
__C.DATASET.LASOT.ROOT = '/home/xiao/Dataset/lasot/crop511'
__C.DATASET.LASOT.ANNO = '/home/xiao/Dataset/lasot/train.json'
...
__C.BACKBONE.PRETRAINED = './pretrained_models'
...
__C.REFINE.REFINE = True

__C.REFINE.TYPE = 'Refinement'

__C.REFINE.KWARGS = CN(new_allowed=True)

__C.REFINE.CLS_KWARGS = CN(new_allowed=True)

__C.REFINE.LOC_KWARGS = CN(new_allowed=True)

__C.REFINE.POS_SAMPLETYPE = 'gaussian'

__C.REFINE.NEG_SAMPLETYPE = 'uniform'

__C.REFINE.TRANS_POS = 0.1

__C.REFINE.TRANS_NEG_INIT = 1

__C.REFINE.SCALE_NEG_INIT = 1.5

__C.REFINE.SCALE_POS = 1.3

__C.REFINE.N_POS_INIT = 16

__C.REFINE.N_NEG_INIT = 96

__C.REFINE.OVERLAP_POS_INIT = [0.7, 1]  #0.6

__C.REFINE.OVERLAP_NEG_INIT = [0, 0.3]#0.3

__C.REFINE.OVERLAP_POS_BOX = [0.6,1]
